...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/test_master_local.log'),
...
class TestMaster:
    def __init__(self):
        ...
        try:
            ...
            self.sock = self.osc_server.listen(address='127.0.0.1', port=7000, default=True)
    ...
    def handle_slave_announce(self, slave_id, orientation):
        try:
            ...
            logging.info(f"Created client connection to slave on port {port}")
        except Exception as e:
